    ...
    <div name="about" className="pt-24 bg-slate-400">
      <div className="flex items-center justify-evenly gap-y-2 gap-x-4 p-2 flex-wrap">
        <div className="grid w-1/5 border-4 border-secondary">
          ...
          <p className="border-2 border-secondary text-center bg-primary">Embroidered Cap</p>
        </div>
        <div className="grid w-1/5 border-4 border-secondary">
          <img src={gift_pack_pint} alt="Image 2"></img>
          <p className="border-2 border-secondary text-center bg-primary">Pint Glass Gift Pack</p>
        </div>
        <div className="grid w-1/5 border-4 border-secondary">
          <img src={lake_time_growler} alt="Image 3"></img>
          <p className="border-2 border-secondary text-center bg-primary">Lake Time Growler</p>
        </div>
        <div className="grid w-1/5 border-4 border-secondary">
          <img src={lots_of_shirts} alt="Image 4"></img>
          <p className="border-2 border-secondary text-center bg-primary">t-Shits</p>
        </div>
